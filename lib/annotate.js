...
(function() {
  ...
  jQuery.widget('IKS.annotationSelector', {
    ...
    annotate: function(entityEnhancement, options) {
      var entityClass, entityHtml, entityType, entityUri, newElement, organisation, person, place, rel, sType, ui, _ref;
      ...
      person = _(sType).detect(function(t) {
        if (t.indexOf('Person')) {
          return true;
        }
      });
      place = _(sType).detect(function(t) {
        if (t.indexOf('Place')) {
          return true;
        }
      });
      organisation = _(sType).detect(function(t) {
        if (t.indexOf('Organisation')) {
          return true;
        }
      });
      if (person !== "") {
