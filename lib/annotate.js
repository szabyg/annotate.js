...
(function() {
  var Backbone, EntityCache, Stanbol, VIE, delayThrottle, jQuery, ns, root, uriSuffix, vie, _, _base,
  ...
  jQuery.widget('IKS.annotate', {
    ...
    _checkForChanges: function() {
      var el, hash, _i, _len, _ref, _results;
      _ref = this._findElementsToAnalyze();
      _results = [];
    ...
    _listNonblockElements: function(el) {
      ...
      isDevidable = function(el) {
        var child, sum, _i, _len, _ref;
        sum = "";
        _ref = jQuery(el).children();
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          child = _ref[_i];
