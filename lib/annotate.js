    ...
    _create: function() {
      ...
      if (this.isAnnotated()) {
        ...
        return this.options.cache.get(this.linkedEntity.uri, this, function(cachedEntity) {
          ...
          _this.linkedEntity.label = VIE.Util.getPreferredLangForPreferredProperty(cachedEntity, ["skos:prefLabel", "rdfs:label"], [userLang, "en"]);
          _(cachedEntity.get("rdfs:label")).detect(function(label) {
