(function() {
  ...
  (function(jQuery) {
    ...
    Stanbol.TextEnhancement.prototype = {
      ...
      getEntityEnhancements: function() {
        ...
        rawList = _(entityAnnotations).filter(__bind(function(ann) {
          ...
          if ((relations.indexOf(this._enhancement.getSubject())) !== -1) {
            return true;
          } else {
            return false;
          }
    ...
    Stanbol.EntityEnhancement.prototype = {
      ...
      getUri: function() {
        return this._vals("enhancer:entity-reference");
      },
      getTextEnhancement: function() {
        return this._textEnhancement;
      },
      getTypes: function() {
        return this._vals("enhancer:entity-type");
      },
      getConfidence: function() {
    ...
    jQuery.widget('IKS.annotate', {
      ...
      enable: function(cb) {
        ...
        return this.options.vie.analyze({
          ...
          var textAnnotations;
          this._logger.info("rdfResult:", enhancements);
